...
def show_venue(venue_id):
  ...
  past_shows = Venue.query.filter(Venue.start_time < datetime.now() and Venue.id == venue.id).all()

  num_past_shows = Venue.query.filter(Venue.start_time < datetime.now() and Venue.id == venue.id).count()

  upcoming_shows = Venue.query.filter(Venue.start_time > datetime.now() and Venue.id == venue.id).all()

  num_upcoming_shows = Venue.query.filter(Venue.start_time > datetime.now() and Venue.id == venue.id).count()
